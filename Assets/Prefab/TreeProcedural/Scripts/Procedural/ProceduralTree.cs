...
namespace Procedural {
	...
	public class ProceduralTree : ProceduralBase {
	...
	public class TreeData {
		...
		public void Setup() {
			randomSeed = Mathf.RoundToInt(UnityEngine.Random.Range(-100000, 100000));
	...
	public class TreeBranch {
		...
		Vector3 from, to;
		float fromRadius, toRadius, length, offset;
		...
		List<TreeSegment> BuildSegments (TreeData data, float fromRadius, float toRadius, Vector3 normal, Vector3 binormal) {
			...
			var curve = new CatmullRom(points);
			var frames = curve.ComputeFrenetSerrets(data.heightSegments, normal, binormal, false);
	...
	public class TreeSegment {
		...
		public FrenetSerret Frame { get { return frame; } }
		...
		public TreeSegment(FrenetSerret frame, Vector3 position, float radius) {
			this.frame = frame;
